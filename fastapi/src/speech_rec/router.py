...
def transcribe_and_generate_quiz(
    ...
    service_info = ServiceInfo(service='OpenAIGPT', service_key='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')  # Replace with your API key
